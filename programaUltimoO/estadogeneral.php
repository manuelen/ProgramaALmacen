...
$img_eli='<img src="imagenes/eliminar.png" border="0" align="absmiddle" width="25" height="25" title="Eliminar" />';
			...
			require('conexion.php');
						...
						$resultado=mysql_query("select * from controles");
            ...
            <br>
                ...
                <tr>
			<th colspan="7"  style=" background-image:url(imagenes/Sin_titulo.png);" ><font color="#FFFFFF" size="+1">INFORMACIÓN GENERAL DE CONTROLES</font></th>
			</tr> 
				<tr valign="top">
					<td width="100" align="center"  style=" background-image:url(imagenes/Sin_titulo.png);">
						<font color="#FFFFFF" size="+1">Código Control</font>
          </td>
					<td width="100" align="center"  style=" background-image:url(imagenes/Sin_titulo.png);">
						<font color="#FFFFFF" size="+1">Codigo Equipo</font>
                  </td>
<td width="100" align="center"  style=" background-image:url(imagenes/Sin_titulo.png);">
						<font color="#FFFFFF" size="+1" >Personal Encargado</font>
                  </td>
<td width="100" align="center"  style=" background-image:url(imagenes/Sin_titulo.png);">
						<font color="#FFFFFF" size="+1" >Actividad</font>
...
<td width="100" align="center" style=" background-image:url(imagenes/Sin_titulo.png);">
        ...
        <?php
			$sql="SELECT * FROM controles ORDER BY ".$orden." ASC LIMIT ".$limitInf.",".$tamPag;
