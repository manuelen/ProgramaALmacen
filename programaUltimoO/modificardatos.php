...
if($_SESSION['cargo']=="Administrador"){?>
 <!--form name="herramienta" method="post" action="modificardatos.php">
...
<form name="usuario" method="post" action="modificardatos2.php">
<table align="center" width="300">
	<tr>
	...
	<tr>
		...
		<td><input  type="text" name="telefono" maxlength="16" size="22" value="<?php echo $fila['telefono']; ?>"></td>
    ...
    <tr>
		...
		<td><input  type="text" name="nombre" maxlength="40" size="22" value="<?php echo $fila['nombre']; ?>"></td>
  
	</tr>
    
    	<tr>
		<td><font>Apellido: </font></td>
		<td><input  type="text" name="apellido" maxlength="40" size="22" value="<?php echo $fila['apellido']; ?>"></td>
        
	</tr>
    
    	<tr>
		<td><font>Usuario: </font></td>
		<td><input  type="text" name="nombreusuario" maxlength="40" size="22" value="<?php echo $fila['nombreusuario']; ?>"></td>
        
     </tr>
    <tr>
		<td><font>Contraseña: </font></td>
		<td><input  type="Password" name="codigo" maxlength="20" size="22" value=""></td>
        
	</tr>
        <tr>
		<td><font>Pregunta Secreta: </font></td>
		<td><input  type="text" name="pregunta" maxlength="20" size="22" value="<?php echo $fila['pregunta']; ?>"></td>
        
	</tr>    <tr>
		<td><font>Respuesta Secreta: </font></td>
		<td><input  type="text" name="respuesta" maxlength="20" size="22" value="<?php echo $fila['respuesta']; ?>"></td>
        
	</tr>
        
	
	<tr>
		<td colspan="2" align="center"><input type="submit" name="enviar" value="Modificar" onClick="valida_envia3()"/>&nbsp;&nbsp;&nbsp;&nbsp;
