...
<div id="columna2" align="center">
            ...
            <br>
            <form name="encargado" method="post" action="eliminarencargado.php">
...
<br/>
			...
			{?>
            <br>
            <form name="eliminarencargado" method="POST" action="eliminarencargado1.php">
				<table align="center">
                	<tr>
		<th colspan="2" style="background-image:url(imagenes/Sin_titulo.png);"><font color="#FFFFFF" size="+1">ELIMINAR PERSONAL</font></th>
					</tr>
				<tr valign="top">
					<td align="right">
						<font color="#000000">Cédula:&nbsp;</font></td>
					<td>
					<input name="cedula" readonly="" size="15" maxlength="30" value="<?php echo $fila['cedula']; ?>">
					</td>
				</tr> 
				<tr valign="top">
					<td align="right">
						<font color="#000000">Nombre:&nbsp;</font></td>
					<td>
					<input type="text" readonly="" name="nombre" size="15" maxlength="30" value="<?php echo $fila['nombre']; ?>">
                    </td>
				</tr> 
				<tr valign="top">
					<td align="right">
						<font color="#000000">Apellido:&nbsp;</font></td>
					<td>
			

  		<input type="text" readonly="" name="Apellido" size="15" maxlength="30" value="<?php echo $fila['apellido']; ?>">

                    </td>
				</tr>
				<tr valign="top">
				<td align="right">
						<font color="#000000">Cargo:&nbsp;</font></td>
					<td>
					<input name="modelo" readonly="" type="text" size="15" maxlength="30" value="<?php echo $fila['cargo']; ?>">
                    </td>
				</tr>
