...
<table align="center" width="280" style="margin-left:10;" border="1" bgcolor="#FFFFFF">
	...
	<tr>
		...
		<select name="cargo">
			...
			<input name="cedula" type="text"  size="18" maxlength="8" onBlur=validarSiNumero(this.value) id="lastname" tooltipText="Por favor introduzca su Cédula de Identidad"><font color="red">*</font></td>
	</tr>
	<tr>
		<td><font>Nombre: </font></td>
		<td><input  type="text" name="nombre" maxlength="50" size="25" id="lastname" tooltipText="Ingrese su primer Nombre"><font color="red">*</font></td>
	</tr>
    <tr>
		<td><font>Apellido: </font></td>
		<td><input  type="text" name="apellido" maxlength="50" size="25" id="lastname" tooltipText="Ingrese su primer Apellido"><font color="red">*</font></td>
	</tr>
	<tr>
		<td><font>Teléfono: </font></td>
		<td><input  type="text" name="telefono" maxlength="11" size="25" onBlur=validarNumero(this.value) id="lastname" tooltipText="Ingrese un número de Contacto preferiblente Celular"><font color="red">*</font></td>
	</tr>

    <tr>
		<td><font>Curso: </font></td>
		<td><select name="curso" id="lastname" tooltipText="Seleccione el Curso que desea realizar">
...
require('conexion.php');
    ...
    <input type=button value="Ingresar otro Curso" onClick="window.open('registrocurso.php','miventana','width=300,height=200,menubar=no'); " title="Para ingresar otro curso haga 'Click Aquí' y posteriormente seleccionar de la lista" id="lastname" tooltipText="Para ingresar otro curso haga 'Click Aquí' y posteriormente seleccionar de la lista"></td>
