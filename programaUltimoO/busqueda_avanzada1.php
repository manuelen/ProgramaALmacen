...
<form name="frmbusqueda" action="">
    ...
    <div align="center" style="background-image:url(imagenes/Sint%C3%ADtulo.jpg);"><font>Ingrese palabra clave para iniciar la búsqueda:</font>
    <input type="text" name="dato" id="padre">
    <input type="submit" value="Consultar" id="padre">
    </div>
    </form><br/>
<script>
$(document).ready(function(e) {
  $("#metodo_ajax").load("busqueda(1).php?busqueda=1");
});
$("#padre").keyup(function(){
$("#metodo_ajax").load("busqueda(1).php?busqueda="+$("#padre").val());
});
