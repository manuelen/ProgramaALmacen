...
<?php
				...
				$img_modi='<img src="imagenes/modificar.png" border="0" align="absmiddle" width="25" height="25" title="Modificar" />';
						...
						$resultado=mysql_query("select * from encargados");
            ...
            <br>
                ...
                <tr>
			<th colspan="7" style="background-image:url(imagenes/Sin_titulo.png);"><font color="#FFFFFF" size="+1">INFORMACIÓN GENERAL DEL PERSONAL</font></th>
			</tr> 
				<tr valign="top">
					<td width="100" align="center" style="background-image:url(imagenes/Sin_titulo.png);">
						<font color="#FFFFFF" size="+1">Cédula</font>
          </td>
					<td width="100" align="center" style="background-image:url(imagenes/Sin_titulo.png);">
...
<td width="100" align="center" style="background-image:url(imagenes/Sin_titulo.png);">
						<font color="#FFFFFF" size="+1" >Cargo</font>
			<?php
...
<td width="100" align="center" style="background-image:url(imagenes/Sin_titulo.png);">
        ...
        <?php
			$sql="SELECT * FROM encargados ORDER BY ".$orden." ASC LIMIT ".$limitInf.",".$tamPag;
			...
			for($i=0;$i<$fila;$i++) 
			{
				echo "<tr valign='top'>";
					...
					if ($_SESSION['cargo']=='Administrador'){
					echo"<td>";
						echo	"<a href='eliminarencargado.php?cedula=".$fila['cedula']."' >";
							echo	$img_eli;		
							echo	"</a>\n"; ?>
                            &nbsp;
                            						<?php
