...
<div id="columna2" align="center">
            ...
            <form name="herramienta" method="post" action="mantenimientoequipo.php">
...
<br/>
		...
		this.location.href='mantenimientoequipo.php';
            ...
            <form name="mantenimiento" method="post" action="mantenimientoequipo1.php">
        ...
        ?>
  				...
  				<tr valign="top">
					<td >
						<font >Tipo:&nbsp;</font></td>
					<td>
					<select name="tipo" value="<?php echo $fila['tipo']; ?>">
                    <option selected value="">--Tipo mantenimiento--</option>
                	...
                	<tr valign="top">
					<td >
						<font >Ingrese fecha de Recuperación:&nbsp;</font></td>
                    <td>
					<input name="fecha2" type="text" id="dateArrival" onClick="popUpCalendar(this, mantenimiento.dateArrival, 'yyyy-mm-dd');" size="10">
					</td>
                   
				</tr> 		
                     
                	<tr>
		<td colspan="2" align="center"><input type="submit" name="enviar" value="Aplicar"/>&nbsp;&nbsp;&nbsp;&nbsp;
		<input type="reset" name="cancelar" value="Cancelar"/></td>
	</tr>
