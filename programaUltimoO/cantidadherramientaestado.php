...
<div id="columna2" align="center">
				...
				require('conexion.php');
						...
						$resultado=mysql_query("select * from estados");
						if(!$resultado)
						{
						...
						{		
                          ...
                          <tr>
			<th colspan="7"  style=" background-image:url(imagenes/Sin_titulo.png);" ><font color="#FFFFFF" size="+1"> CANTIDAD DE HERRAMIENTAS POR ESTADO </font></th>
			</tr> 
                            								<tr>
		<th style=" background-image:url(imagenes/Sin_titulo.png);"><font color="#FFFFFF" size="+1">ESTADO</font></th>
        		<th style=" background-image:url(imagenes/Sin_titulo.png);"><font color="#FFFFFF" size="+1">CANTIDAD DE HERRAMIENTAS</font></th>
						...
						for($i=0;$i<$fila;$i++) 
		{                       
		$cantidad=mysql_query("select count(estado) from equipos where estado='$fila[estado]' and ubicacion='$laboratorio'");
