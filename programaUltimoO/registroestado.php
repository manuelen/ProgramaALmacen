<form name="estado" method="post" action="registroestado1.php">
<table align="center" width="300">
	<tr>
		<th colspan="2" style="background-image:url(imagenes/Sin_titulo.png);"><font color="#FFFFFF" size="+1">REGISTRAR ESTADO</font></th>
	</tr>
	<tr>
		<td ><font>Estado: </font></td>
		<td><input name="estado" type="text" size="22"></td>
	</tr>
