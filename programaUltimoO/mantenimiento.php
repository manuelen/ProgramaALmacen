...
<form name="herramienta" method="post" action="mantenimiento.php">
<table align="center" width="300">
	<tr>
		<th colspan="2" style="background-image:url(imagenes/Sin_titulo.png);"><font color="#FFFFFF" size="+1">CONSULTAR MANTENIMIENTO</font></th>
	</tr>
	<tr>
	...
	<tr>
		...
		<input type="reset" name="cancelar" value="Cancelar"/></td>
			...
			<?php 
				...
				if (!isset($_POST['codigoequipo'])){
					...
					<script>
		             ...
		             this.location.href='mantenimiento.php';
		             </script>
            ...
            <br>
				<table align="center">
                	<tr>
		<th colspan="2" style="background-image:url(imagenes/Sin_titulo.png);"><font color="#FFFFFF" size="+1">DATOS DEL MANTENIMIENTO</font></th>
	</tr>
				<tr valign="top">
					<td >
						<font >Código:&nbsp;</font></td>
				...
				<tr valign="top">
					<td >
						<font >Código Mantenimiento:&nbsp;</font></td>
					<td>
					<?php echo $fila['codigomantenimiento']; ?>
                    </td>
				</tr> 
				<tr valign="top">
					<td>
