...
$img_eli='<img src="imagenes/eliminar.png" border="0" align="absmiddle" width="25" height="25" title="Eliminar" />';
				...
				require('conexion.php');
						...
						$resultado=mysql_query("select * from laboratorios");
            ...
            <br>
                ...
                <tr>
			<th colspan="8" style="background-image:url(imagenes/Sin_titulo.png);"><font color="#FFFFFF" size="+1">INFORMACIÓN GENERAL DE LABORATORIOS</font></th>
			</tr> 
				<tr valign="top">
					...
					<td width="100" align="center" style="background-image:url(imagenes/Sin_titulo.png);">
						<font color="#FFFFFF" size="+1">Dependencia</font>
                  </td>
<td width="100" align="center" style="background-image:url(imagenes/Sin_titulo.png);">
						<font color="#FFFFFF" size="+1" >Personal Encargado</font>
                  </td>
                  <td width="100" align="center" style="background-image:url(imagenes/Sin_titulo.png);">
						<font color="#FFFFFF" size="+1">Otro Personal</font>
                  </td>
					<?php
...
<td width="100" align="center" style="background-image:url(imagenes/Sin_titulo.png);">
        ...
        <?php
			$sql="SELECT * FROM laboratorios ORDER BY ".$orden." ASC LIMIT ".$limitInf.",".$tamPag;
			...
			for($i=0;$i<$fila;$i++) 
			{
				echo "<tr valign='top'>";
                    ...
                    echo "</td>";
					echo"<td>";
						echo $fila['dependencia'];
                    echo "</td>";
					echo"<td>";
						echo $fila['encargado'];
                    echo "</td>";
					echo"<td>";
						echo $fila['encargado2'];
                    echo "</td>";
					if ($_SESSION['cargo']=='Administrador'){
					echo"<td>";
						echo	"<a href='eliminarlaboratorio.php?nombre=".$fila['nombre']."' >";
							echo	$img_eli;		
							echo	"</a>\n"; ?>
                            &nbsp;
                            						<?php
