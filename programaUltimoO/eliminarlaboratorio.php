...
<div id="columna2" align="center"></br>
 <form name="laboratorio" method="post" action="eliminarlaboratorio.php">
<table align="center" width="300">
	...
	<tr>
		...
		<td><input name="nombre" type="text" size="15" maxlength="30"></td>
	</tr>
...
<br/>
			...
			{?>
            <br>
            <form name="eliminarlaboratorio" method="POST" action="eliminarlaboratorio1.php">
				<table align="center">
                	<tr>
		<th colspan="2" style="background-image:url(imagenes/Sin_titulo.png);"><font color="#FFFFFF" size="+1">ELIMINAR LABORATORIO</font></th>
					</tr>
				<tr valign="top">
					<td >
						<font >Nombre:&nbsp;</font></td>
					<td>
					<input name="nombre" readonly="" size="15" maxlength="30" value="<?php echo $fila['nombre']; ?>">
					</td>
				</tr> 
				<tr valign="top">
					<td >
					...
					<td>
					<input type="text" readonly="" name="dependencia" size="15" maxlength="30" value="<?php echo $fila['dependencia']; ?>">
                    </td>
				</tr> 
				<tr valign="top">
					<td >
					...
					<td>
  		<input type="text" readonly="" name="encargado" size="15" maxlength="30" value="<?php echo $fila['encargado']; ?>">
                   </td>
				</tr>
                				<tr valign="top">
					<td >
						<font>Nombre Personal2:&nbsp;</font></td>
					<td>
  		<input type="text" readonly="" name="encargado2" size="15" maxlength="30" value="<?php echo $fila['encargado2']; ?>">
                   </td>
				</tr>
