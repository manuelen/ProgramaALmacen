...
$pdf->Row(array('Nombre', 'Cédula', 'Apellido', 'Teléfono','curso')); // creamos nuestra fila con las columnas fecha(fecha de la visita al medico), medico(nombre del medico que nos atendio), consultorio y el diagnostico en esa visita.  
