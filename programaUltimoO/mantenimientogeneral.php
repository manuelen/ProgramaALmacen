...
$img_eli='<img src="imagenes/eliminar.png" border="0" align="absmiddle" width="25" height="25" title="Eliminar" />';
				...
				require('conexion.php');
						...
						$resultado=mysql_query("select * from mantenimientos");
            ...
            <br>
                ...
                <tr>
			<th colspan="7"  style=" background-image:url(imagenes/Sin_titulo.png);" ><font color="#FFFFFF" size="+1">INFORMACIÓN GENERAL DE MANTENIMIENTOS</font></th>
			</tr> 
				<tr valign="top">
					...
					<td width="100" align="center"  style=" background-image:url(imagenes/Sin_titulo.png);">
						<font color="#FFFFFF" size="+1">Código Mantenimiento</font>
                  </td>
<td width="100" align="center"  style=" background-image:url(imagenes/Sin_titulo.png);">
...
<td width="100" align="center" style=" background-image:url(imagenes/Sin_titulo.png);">
        ...
        <?php
			$sql="SELECT * FROM mantenimientos ORDER BY ".$orden." ASC LIMIT ".$limitInf.",".$tamPag;
	...
	if ($_SESSION['cargo']=='Administrador'){
					echo"<td>";
							...
							echo 	"<a href='mantenimientoequipo.php?codigoequipo=".$fila['codigoequipo']."' >";
							echo	$img_modi;		
							echo	"</a>";
