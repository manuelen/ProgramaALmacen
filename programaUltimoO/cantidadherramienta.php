			...
			<?php 
				...
				$laboratorio=$_REQUEST['nombre'];
						...
						{		
							...
							<table align="center" border="2" style="border-style:groove" cellpadding="1" cellspacing="1" width="400">
                            <tr>
			<th colspan="7"  style=" background-image:url(imagenes/Sin_titulo.png);" ><font color="#FFFFFF" size="+1">CANTIDAD DE HERRAMIENTAS POR LABORATORIO</font></th>
			</tr> 
                            								<tr>
		<th  style=" background-image:url(imagenes/Sin_titulo.png);"><font color="#FFFFFF" size="+1">UBICACI&Oacute;N</font></th>
        		<th  style=" background-image:url(imagenes/Sin_titulo.png);"><font color="#FFFFFF" size="+1">CANTIDAD DE HERRAMIENTAS</font></th>
						...
						for($i=0;$i<$fila;$i++) 
		{                       
		$cantidad=mysql_query("select count(ubicacion) from equipos where ubicacion='$fila[nombre]'");
